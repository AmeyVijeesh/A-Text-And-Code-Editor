...
def text_editor():
    ...
    code_editor_button = Button(root, text='Open Code Editor', bg='#282828', fg='white', command=code_edit)
    code_editor_button.place(x=650, y=12)
